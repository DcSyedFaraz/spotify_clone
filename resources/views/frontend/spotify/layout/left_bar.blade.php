<div class="left-bar d-none">
    <div class="musicplayer-main-sec">
    ...
    <!-- Queue Section -->
    <div class="sidebar-inner1 my-2">
        <h3 class="credits">Queue</h3>
        <ul class="list-group queue-list">
            <!-- Queued tracks will be appended here dynamically -->
        </ul>
    </div>
